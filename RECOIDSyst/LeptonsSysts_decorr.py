...
if (year=="2024"):
   ...
   file_name = '/test_deco_SKIMMED.root'
...
for Type in List:
   ...
   #for event in tree:
      ...
      for i in range (0,4):
         ...
         if abs(tree.LepLepId[i]) == 11:
            ...
            err_lep_up[i] = tree.LepSFUnc_IDsyst[i]
            err_lep_dn[i] = tree.LepSFUnc_IDsyst[i]
            #elec_idx += 1
   ...
   if (uncorrelated_leptons):
      ...
      print("================================")
      print("4e = +{:.2f}% -{:.2f}%  4mu = +{:.1f}% -{:.1f}%".format(100*(comb_uncor_4e_up**0.5),100*(comb_uncor_4e_dn**0.5),100*(comb_uncor_4mu_up**0.5),100*(comb_uncor_4mu_dn**0.5)))
